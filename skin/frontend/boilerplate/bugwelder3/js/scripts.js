...
!function(a, b) {
    ...
    function w(a, b, c) {
        var d = Ub.exec(b);
        return d ? // Guard against undefined "subtract", e.g., when used as in cssHooks
        Math.max(0, d[1] - (c || 0)) + (d[2] || "px") : b;
    }
    ...
    function z(a) {
        var b = T, c = Xb[a];
        return c || (c = A(a, b), // If the simple way fails, read from inside an iframe
        "none" !== c && c || (// Use the already-created iframe if possible
        Rb = (Rb || fb("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(b.documentElement), 
        // Always write a new HTML skeleton so Webkit and Firefox don't choke on reuse
        b = (Rb[0].contentWindow || Rb[0].contentDocument).document, b.write("<!doctype html><html><body>"), 
        b.close(), c = A(a, b), Rb.detach()), // Store the correct default display
        Xb[a] = c), c;
    }
 ...
 */
    ...
    fb.fn = fb.prototype = {
        ...
        init: function(a, c, d) {
            ...
            if ("string" == typeof a) {
                ...
                return f = T.getElementById(e[2]), // Check parentNode to catch when Blackberry 4.6 returns
                // nodes that are no longer in the document #6963
                f && f.parentNode && (// Inject the element directly into the jQuery object
                this.length = 1, this[0] = f), this.context = T, this.selector = a, this;
            }
        ...
        get: function(a) {
            return null == a ? // Return a 'clean' array
    ...
    fb.fn.init.prototype = fb.fn, fb.extend = fb.fn.extend = function() {
        ...
        proxy: function(a, c) {
            ...
            e = ab.call(arguments, 2), f = function() {
        ...
        return Q || (Q = fb.Deferred(), // Catch cases where $(document).ready() is called after the browser event has already occurred.
 ...
 */
        ...
        function o(a, b, c) {
            ...
            return b.first ? // Check against closest ancestor/preceding element
            function(b, c, f) {
        ...
        function s(a) {
            ...
            i = o(function(a) {
                ...
                if (c = z.filter[a[h].type].apply(null, a[h].matches), c[N]) {
                    ...
                    return r(h > 1 && p(k), h > 1 && n(// If the preceding token was a descendant combinator, insert an implicit any-element `*`
 ...
 */
	...
	---------------------------------------------------------------------- */
            ...
            V = H.compareDocumentPosition ? function(a, c) {
                ...
                return d ? // Disconnected nodes
                1 & d || !x.sortDetached && c.compareDocumentPosition(a) === d ? // Choose the first element that is related to our preferred document
                a === b || M(O, a) ? -1 : c === b || M(O, c) ? 1 : E ? cb.call(E, a) - cb.call(E, c) : 0 : 4 & d ? -1 : 1 : a.compareDocumentPosition ? -1 : 1;
            } : function(a, c) {
                ...
                for (;i[e] === j[e]; ) e++;
                return e ? // Do a sibling check if the nodes have a common ancestor
 ...
 */
        A = c.getText = function(a) {
            ...
            preFilter: {
                ATTR: function(a) {
                    return a[1] = a[1].replace(xb, yb), // Move the given value to match[3] whether quoted or unquoted
                    a[3] = (a[4] || a[5] || "").replace(xb, yb), "~=" === a[2] && (a[3] = " " + a[3] + " "), 
                    a.slice(0, 4);
                },
                CHILD: function(a) {
			...
			*/
                ...
                PSEUDO: function(a) {
                    var c, d = !a[5] && a[2];
                    return rb.CHILD.test(a[0]) ? null : (// Accept quoted arguments as-is
                    ...
                    a[0] = a[0].slice(0, c), a[2] = d.slice(0, c)), a.slice(0, 3));
                }
            },
            filter: {
                TAG: function(a) {
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    return 1 === d && 0 === e ? // Shortcut for :nth-*(n)
                    function(a) {
                        return !!a.parentNode;
                    } : function(b, c, i) {
                ...
                PSEUDO: function(a, b) {
                    ...
                    f.length > 1 ? (d = [ a, a, "", b ], z.setFilters.hasOwnProperty(a.toLowerCase()) ? e(function(a, c) {
 ...
 */
    fb.Callbacks = function(a) {
        ...
        b.clearCloneStyle = "content-box" === e.style.backgroundClip, // Run tests that need a body at doc ready
        fb(function() {
...
*/
    ...
    pb = new e(), qb = new e(), fb.extend({
        ...
        queue: function(a, b, c) {
            var d;
            return a ? (b = (b || "fx") + "queue", d = qb.get(a, b), // Speed up dequeue by getting out quickly if this is just a lookup
            c && (!d || fb.isArray(c) ? d = qb.access(a, b, fb.makeArray(c)) : d.push(c)), d || []) : void 0;
        },
    ...
    fb.fn.extend({
        ...
        val: function(a) {
            var c, d, e, f = this[0];
            {
                ...
                c && "get" in c && (d = c.get(f, "value")) !== b ? d : (d = f.value, "string" == typeof d ? // handle most common string cases
        ...
        attr: function(a, c, d) {
            ...
            1 === g && fb.isXMLDoc(a) || (c = c.toLowerCase(), e = fb.attrHooks[c] || (fb.expr.match.bool.test(c) ? ub : tb)), 
            d === b ? e && "get" in e && null !== (f = e.get(a, c)) ? f : (f = fb.find.attr(a, c), 
        ...
        prop: function(a, c, d) {
            ...
            c = fb.propFix[c] || c, f = fb.propHooks[c]), d !== b ? f && "set" in f && (e = f.set(a, d, c)) !== b ? e : a[c] = d : f && "get" in f && null !== (e = f.get(a, c)) ? e : a[c];
        },
        propHooks: {
            tabIndex: {
                get: function(a) {
    ...
    ub = {
        set: function(a, b, c) {
            return b === !1 ? // Remove boolean attributes when set to false
            fb.removeAttr(a, c) : a.setAttribute(c, c), c;
        }
 ...
 */
    fb.event = {
        ...
        trigger: function(c, d, e, f) {
            ...
            m = fb.event.special[o] || {}, f || !m.trigger || m.trigger.apply(e, d) !== !1)) {
                ...
                return c.type = o, // If nobody prevented the default action, do it now
                ...
                fb.event.triggered = o, e[o](), fb.event.triggered = b, i && (e[k] = i)), c.result;
            }
        },
        dispatch: function(a) {
        ...
        this[fb.expando] = !0, void 0) : new fb.Event(a, b);
    ...
    fb.support.focusinBubbles || fb.each({
        ...
        off: function(a, c, d) {
            ...
            return (c === !1 || "function" == typeof c) && (// ( types [, fn] )
            d = c, c = b), d === !1 && (d = h), this.each(function() {
    ...
    fb.fn.extend({
        ...
        is: function(a) {
            return !!k(this, // If this is a positional/relative selector, check membership in the returned set
            // so $("p:first").is("p:last") won't return true for a doc with two "p".
            "string" == typeof a && Eb.test(a) ? fb(a) : a || [], !1).length;
        },
        ...
        index: function(a) {
            ...
            a.jquery ? a[0] : a) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1;
        },
        add: function(a, b) {
        ...
        fb.fn[a] = function(c, d) {
            ...
            Db.test(a) && e.reverse()), this.pushStack(e);
        };
    }), fb.extend({
    ...
    Pb.th = Pb.td, fb.fn.extend({
        ...
        wrapAll: function(a) {
            ...
            }) : (this[0] && (// The elements to wrap the target around
            b = fb(a, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && b.insertBefore(this[0]), 
            b.map(function() {
    ...
    fb.fn.extend({
        ...
        css: function(a, c, d, e) {
            ...
            "normal" === f && c in Zb && (f = Zb[c]), "" === d || d ? (g = parseFloat(f), d === !0 || fb.isNumeric(g) ? g || 0 : f) : f;
        }
    }), Qb = function(a, c, d) {
    ...
    fc = pc.exec(gc.toLowerCase()) || [], fb.fn.load = function(a, c, d) {
        ...
        return i >= 0 && (e = a.slice(i), a = a.slice(0, i)), // If it's a function
    ...
    fb.each([ "ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend" ], function(a, b) {
		...
		*/
        ...
        ajaxSetup: function(a, b) {
            return b ? // Building a settings object
    ...
    fb.Animation = fb.extend(J, {
        ...
        _default: {
            get: function(a) {
                var b;
                return null == a.elem[a.prop] || a.elem.style && null != a.elem.style[a.prop] ? (// passing an empty string as a 3rd parameter to .css will automatically
                // attempt a parseFloat and fallback to a string if the parse fails
                // so, simple values such as "10px" are parsed to Float.
                // complex values such as "rotate(1rad)" are returned as is.
                b = fb.css(a.elem, a.prop, ""), b && "auto" !== b ? b : 0) : a.elem[a.prop];
            },
            set: function(a) {
    ...
    fb.fx.step = {}, fb.expr && fb.expr.filters && (fb.expr.filters.animated = function(a) {
        ...
        typeof e.getBoundingClientRect !== R && (f = e.getBoundingClientRect()), d = O(g), 
        {
        ...
        position: function() {
            if (this[0]) {
                ...
                d.top += fb.css(a[0], "borderTopWidth", !0), d.left += fb.css(a[0], "borderLeftWidth", !0)), 
                {
        ...
        fb.each({
            ...
            fb.fn[e] = function(e, f) {
                ...
                return fb.access(this, function(c, d, e) {
                    var f;
                    return fb.isWindow(c) ? c.document.documentElement["client" + a] : // Get document width or height
...
+function(a) {
    ...
    }, a.fn.collapse.Constructor = b, // COLLAPSE NO CONFLICT
    // ====================
...
+function(a) {
    ...
    b.DEFAULTS = {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            }, this)), d && this.$backdrop[0].offsetWidth, // force reflow
    ...
    }, a.fn.modal.Constructor = b, // MODAL NO CONFLICT
    // =================
...
+function(a) {
    ...
    b.DEFAULTS = {
        ...
        if (!e.hasClass("active")) {
            ...
            this.$element.one("slid", function() {
                ...
                e.addClass(b), e[0].offsetWidth, // force reflow
    ...
    }, a.fn.carousel.Constructor = b, // CAROUSEL NO CONFLICT
    // ====================
...
jQuery.noConflict(), function(a) {
    ...
    b.prototype = {
        ...
        attachMedia: function() {
            var b = a('[data-toggle="media"]');
            b.length && // When somebody clicks on a link, slide the
            // carousel to the slide which matches the
            // image index and show the modal
            b.on("click", function(b) {
                b.preventDefault();
                var c = a(this), d = a(c.attr("href")), e = d.find(".carousel"), f = parseInt(c.data("index"));
                return e.carousel(f), d.modal("show"), !1;
            });
        }
